	...
	<div align="center">
		<h1 align="center" style="margin-bottom: -15; color: navy">
			...
			<tr>
					...
					<td><input type="text" id="udate" name="examDate" placeholder="Select Exam Date"
			...
			<td align="center">
			<textarea style="width: 170px; resize: none;" name="description" rows="3" placeholder="Enter Short description">
