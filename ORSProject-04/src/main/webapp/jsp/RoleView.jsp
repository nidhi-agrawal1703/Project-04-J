...
<body>
            ...
            <h1 align="center" style="margin-bottom: -15; color: navy">
                <%
                    if (bean != null && bean.getId() > 0) {
                    	System.out.println("bean data: "+bean.getId());
                %>Update<%
                    } else {
                %>Add<%
                    }
	...
	<td align="center"><input type="text" name="name" placeholder="Enter Role Name" value="<%=DataUtility.getStringData(bean.getName())%>"></td>
