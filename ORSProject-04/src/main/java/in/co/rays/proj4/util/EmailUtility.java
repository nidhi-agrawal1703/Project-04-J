...
/**
 * Utility class that performs sending mail operation.
 * 
 * @author Nidhi
 * @version 1.0
 *
...
public class EmailUtility {
	...
	public static void sendMail(EmailMessage emailMessageDTO) throws ApplicationException{
		try {
			...
			//Create and Setup Email Message
			...
			e.printStackTrace();
			throw new ApplicationException("Email Error:" + e.getMessage());
		}
	}
	private static Address[] getInternetAddresses(String emails)throws Exception {
