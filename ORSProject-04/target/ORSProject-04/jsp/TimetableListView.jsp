...
<body>
	...
	<div align="center">
			...
			<h1 align="center" style="margin-bottom: -15; color: navy;">Timetable List</h1>
		...
		<tr>
		<td align="right"><label><b>Course Name</b></label><%=HTMLUtility.getList("courseId",String.valueOf(bean.getCourseId()),courseList) %>
		&emsp;<label><b>Subject Name</b></label><%=HTMLUtility.getList("subjectId",String.valueOf(bean.getSubjectId()),subjectList) %>
			...
			<td align="left"><input type="text" id="udate" name="examDate" placeholder="Select Date of Birth"
				...
				</label>&emsp; <input type="submit" name="operation" value="<%=TimetableListCtl.OP_SEARCH%>">&nbsp;
		...
		<!-- Field table -->
			...
			<tr>
				...
				<td style="text-align: center;"><a href="TimetableCtl?id=<%=bean.getId()%>">Edit</a></td>
			</tr>
			<%}//while %>
			</table>
			...
			<table style="width:100%">
				...
				<td align="center" style="width: 25%"><input type="submit" name="operation" value="<%=TimetableListCtl.OP_NEW%>"></td>
				<td align="center" style="width: 25%"><input type="submit" name="operation" value="<%=TimetableListCtl.OP_DELETE%>"></td>
				<td style="width: 25%" align="right"><input type="submit" name="operation" 
		...
		<%} else {//If  %>
			<table>
				<tr>
				<td align="right"><input type="submit" name="operation" value="<%=TimetableListCtl.OP_BACK%>"></td>
				</tr>
			</table>
		<%} %>
		</form>
