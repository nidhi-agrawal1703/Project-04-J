...
<body>
	<form action="<%=ORSView.USER_CTL %>" method="post">
		...
		<div align="center">
			...
			<td><input type="password" name="confirmPassword" placeholder="Enter confirm password" value="<%=DataUtility.getStringData(bean.getConfirmPassword())%>"></td>
			...
			<td><input type="text" name="mobileNo" placeholder="Enter mobile number" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
